...
This module implements game mechanics, which include the game board, game state, player moves and
stone string objects. Game states are stored as Zobrist hashes.
    ...
    def _remove_string(self, go_string):
        for point in go_string.stones:
            for neighbor in point.neighbors():
                ...
                # Removing stone can create liberties for opponent stones.
